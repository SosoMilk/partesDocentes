...
public class Response {
	...
	public static ResponseEntity<Object> ok(Object responseObj) {
		return response(HttpStatus.OK, "OK :D", responseObj);
	}

	public static ResponseEntity<Object> error(String mensaje) {
		return response(HttpStatus.NOT_ACCEPTABLE, "OK", null);
	}
